package cn.tony.music.views.dialogs;
...
import cn.tony.music.activity.base.AttachDialogFragment;
import cn.tony.music.constent.IConstants;
import cn.tony.music.model.MusicInfo;
import cn.tony.music.model.Playlist;
import cn.tony.music.provider.PlaylistInfo;
import cn.tony.music.provider.PlaylistsManager;
import cn.tony.music.utils.MusicUtils;
import cn.tony.music.views.DividerItemDecoration;
...
public class AddNetPlaylistDialog extends AttachDialogFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.music_fragment_add_playlist, container);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setView((mContext.getLayoutInflater().inflate(R.layout.music_dialog, null)));
                alertDialog.show();
                Window window = alertDialog.getWindow();
                window.setContentView(R.layout.music_dialog);
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (MusicInfo info : musics) {
                                    ...
                                    if (info.islocal) {
                                        if (albumart.equals(MusicUtils.getAlbumdata(getContext(), info.songId)))
                                            break;
    ...
    private class AddPlaylistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.music_fragment_add_playlist_item, parent, false));
        }
