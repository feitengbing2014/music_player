...
public class BillingTextView extends android.support.v7.widget.AppCompatTextView {

    private final static String TAG = BillingTextView.class.getSimpleName();
    ...
    public BillingTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
