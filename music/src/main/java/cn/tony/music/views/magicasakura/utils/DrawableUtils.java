package cn.tony.music.views.magicasakura.utils;
...
import cn.tony.music.views.magicasakura.widgets.TintManager;
...
public abstract class DrawableUtils {
    ...
    public static Drawable createDrawable(Context context, int resId) {
