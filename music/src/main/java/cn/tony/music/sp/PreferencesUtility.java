...
import cn.tony.music.provider.SortOrder;
...
public class PreferencesUtility {
    ...
    public boolean isHideControl() {
        return mPreferences.getInt("isHideControl", 0) == 1;
    }

    public void setHideControl(boolean isHideControl) {
        int time = 0;
        if (isHideControl) {
            time = 1;
        }
        SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt("isHideControl", time);
        editor.apply();
    }

    public void setInteruptVolume(boolean isInteruptVolume) {
        int time = 0;
        if (isInteruptVolume) {
            time = 1;
        }
        SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt("setInteruptVolume", time);
        editor.apply();
    }

    public boolean isInteruptVolume() {
        return mPreferences.getInt("setInteruptVolume", 0) == 1;
    }
}